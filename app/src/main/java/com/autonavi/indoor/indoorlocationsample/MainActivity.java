...
public class MainActivity extends Activity {
    ...
    String[] dangerousPermission = new String[]{Manifest.permission.READ_PHONE_STATE, Manifest.permission.READ_EXTERNAL_STORAGE,
            Manifest.permission.ACCESS_COARSE_LOCATION, Manifest.permission.ACCESS_FINE_LOCATION};
    private static final int READ_PHONE_STATE_REQUEST_CODE = 7;
        ...
        public void onClick(View v)
        {
            switch (v.getId()) {
                case R.id.btnInit:
                    ...
                    boolean hasSelfPermission = PermissionUtils.hasSelfPermissions(MainActivity.this, dangerousPermission);
                    if(hasSelfPermission) {
                        ...
                        mTextView1.setText("授权之后，请重新初始化.");
                        boolean showRationale = PermissionUtils.shouldShowRequestPermissionRationale(MainActivity.this, dangerousPermission);
                                    ...
                                    .setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener() {
                                        ...
                                        public void onClick(DialogInterface dialog, int which) {
                                            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                                                requestPermissions(dangerousPermission, READ_PHONE_STATE_REQUEST_CODE);
                                            }
                                        }
                                    })
                                    .show();
        ...
        switch (requestCode) {
            case READ_PHONE_STATE_REQUEST_CODE: {
                ...
                new AlertDialog.Builder(this)
                        .setTitle("权限")
                        .setMessage(dangerousPermission[0] + "\r\n" + (hasSelfPermission ? "已授权，请重新初始化" : "未授权，将无法定位"))
